  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-2xl mx-4">
        <div
          className="rounded-2xl border border-[#27272a] bg-black/40 backdrop-blur-xl shadow-[0_0_80px_rgba(0,0,0,0.6)]"
          style={{
            boxShadow:
              "0 0 0 1px rgba(255,255,255,0.04), 0 0 80px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.06)",
          }}
        >
          <div className="px-8 py-8 sm:px-12 sm:py-10 flex flex-col items-center">
            ...
            <img
              ...
              alt="Bacancy"
              className="w-12 h-12 mb-5 drop-shadow-[0_0_14px_rgba(249,115,22,0.4)]"
            />
            ...
            {/* Title */}
            <h1
              className="text-white text-center font-black tracking-tight leading-[1.05] mb-3"
            ...
            {/* Errors */}
            {error === "AccessDenied" && (
              <div className="bg-red-500/8 border border-red-500/15 rounded-lg px-4 py-2 mb-4 w-full">
            ...
            <div className="flex justify-center mb-3">
              <LiquidButton
                className="text-white border border-white/15 rounded-full"
                size="lg"
